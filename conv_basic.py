...
conv_method_choice = np.random.choice(["same", "valid"])

conv_res_mat = convolve(mat_A, kernel_matrix, mode=conv_method_choice)
print("Resultant Convolutional Matrix : \n",conv_res_mat)

print("Convolution method choice : ", conv_method_choice)
